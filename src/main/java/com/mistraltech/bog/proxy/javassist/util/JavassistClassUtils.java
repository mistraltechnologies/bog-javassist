package com.mistraltech.bog.proxy.javassist.util;
...
public final class JavassistClassUtils {
    ...
    public static void addConstructor(CtClass ctClass) {
        try {
            final CtConstructor ctConstructor = CtNewConstructor.defaultConstructor(ctClass);
            ctClass.addConstructor(ctConstructor);
        } catch (CannotCompileException e) {
            throw new RuntimeException("Failed to compile class default constructor", e);
        }
    }
    ...
    public static void addConstructor(CtClass ctClass, CtClass[] params, String constructorBody) {
        try {
            final CtConstructor ctConstructor = CtNewConstructor.make(params, null, constructorBody, ctClass);
            ctClass.addConstructor(ctConstructor);
        } catch (CannotCompileException e) {
            throw new RuntimeException("Failed to compile class constructor", e);
        }
    ...
    public static <TM> Class<TM> getClassFrom(CtClass ctClass) {
        try {
